...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE `sanpham` SET tensp='$tensp', gia1='$gia1', soluong='$soluong', mota='$mota', hinhanh1='$hinhanh1', hinhanh2='$hinhanh2', hinhanh3='$hinhanh3', hinhanh4='$hinhanh4', detail='$detail', phanloai='$phanloai' WHERE id='$id'";
